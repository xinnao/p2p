...
<body scroll="no">
	<div id="layout">
		<div id="header">
			<div class="headerNav">
				<!--<a class="logo" href="http://www.suyiapp.com">logo</a>-->
				<ul class="nav">
                <li><font color="#FFFFFF"><?php echo name($uid); ?></font></li>
...
信息管理系统
	...
	<div id="footer">技术支持：<a href="copyright.php" target="dialog">晨曦万杰</a></div>
</body>
</html>