...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="52" align="center">人员列表</td>
        <td width="50" align="center"><a class="button" href="renshi/search.php?url=renshi/ren_list.php" width="600" height="450" target="dialog" mask="true" title="搜索信息"><span>检索</span></a></td>
  </tr>
</table>
	</div>
</div>
...
<div class="panelBar">
		<ul class="toolBar">
         <li><a class="add" href="renshi/ren_add.php" target="navTab" rel="page12"><span>员工录入</span></a></li>
            ...
            <li class="line">line</li>
			<li><a class="add" href="renshi/ren_csv.php" target="_blank"><span>导出Excel文件</span></a></li>
		</ul>
</div>
...
if ('search'==$_POST["action"]){
$order="where $key like '%$word%' and (zhuangtai like '$shiyong' or zhuangtai like '$zhengshi') order by bmid desc,zhiwei desc,jinzhi desc,uid desc";
}else{
$order="where zhuangtai like '$shiyong' or zhuangtai like '$zhengshi' order by bmid desc,zhiwei desc,jinzhi desc,uid desc";	
	}
