...
<html>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <title>
            ...
            成为借入者 - 提供小额贷款、信用贷款、无抵押贷款、购车贷款，更低的贷款利率 - E贷通
        </title>
        ...
        <meta name="description" content="E贷通-提供小额贷款、短期贷款、无抵押贷款、信用贷款、购车贷款，淘宝卖家贷款，网商贷款、享受更低的贷款利率，更便捷的借款流程" />
     
        <meta name="keywords" content="网络借贷，网络贷款，借贷 网络平台，民间借贷，小额贷款，无抵押贷款，信用贷款，投资理财，E贷通"/>
    </head>
    <body>
        <div id="page" class="session_invalid_tag">
<?php require("../header.php"); ?><div class="layout-box">
    <div class="top">
        <b class="cor-l"></b>
        <b class="cor-r"></b>
    </div>
...
function confirmBox(type){
	if(type=="yes"){
		window.open('http://b.qq.com/webc.htm?new=0&sid=4000278080&eid=218808P8z8p8R8y8q8y8Q&o=www.renrendai.com&q=7&ref='+document.location, '_blank', 'height=544, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');
		$(".confirmBox").remove();
		$("#mask").remove();
	}else{
		$(".confirmBox").remove();
...
<script type="text/javascript">	$(function() {
 ...
 <div class="confirmBox" style="display:none;">
    <div class="confirmBoxText">
      ...
      <p>非常感谢您能注册E贷通，请等待客服人员联系您，保证您的手机畅通。若您已经了解，可直接点击下一步，进行资料的上传。</p>
      <p>信用财富，人人享有。感谢您对E贷通的支持。</p>
    </div>
		...
		<div class="clearfix">
			...
			<div class="rightlendstep">
				...
				<div style="display: block" id="user_advance_info_content">
					<form method="post" id="userDetailInfoFormForUpdate" action="../my/updateDetailInfo.action">
...
<div class="user_info_box clearfix" style="width: auto">
	...
	<div class="b" style="padding: 10px 90px">
		请确保您填写的资料真实有效，所有资料将会严格保密。一旦被发现所填资料有虚假，将会影响您在E贷通的信用，对以后借款造成影响。</div>
		...
		if($("#"+o).val()=="请选择"){
  			...
  			return true;
				...
				<div style="display: none" id="user_company_info_content">
					<form method="post" id="userWorkInfoFormForUpdate" action="/my/updateWorkInfo.action">
						<input type="hidden" name="fromType" value="finishAdvanceInfo" />
...
$(function(){
    ...
    jQuery("#borrowForm").validate({
        submitHandler: function(){
            ...
            if(document.forms[2].action.indexOf('tempLoan.action')==-1&&document.forms[2].action.indexOf('previewLoanPage.action')==-1){
		...
		if(id == products[i].id){
			...
			for(var j=0; j < jsonMonth.length; j++){
				if(month == jsonMonth[j].month){
					$("#minRate").html(jsonMonth[j].minInterest+"%");
					$("#maxRate").html(jsonMonth[j].maxInterest+"%");
				}
			}
			break;
		}
...
<form enctype="multipart/form-data" class="borrowForm" method="post" id="borrowForm" action="">
	...
	<div class="item" style="margin-top: 5px">
		...
		<div class="user_info_box_green clearfix" style="width: 548px;">
			...
			<div style="padding-left: 20px;">
				...
				<div class="user_info_item">
					<span> 
					<input type="checkbox" checked="" id="treaty1"> &nbsp;&nbsp;我同意<a href="/guarantee/aboutfee.html" target="_blank">E贷通收费条款</a>
					</span> 
					<span>
	...
	<div style="text-align: center; margin: 10px 0; color: #4A74CA;">
		...
		<input type="submit" id="previewBtn" class="mbtn preview" value=""
			onclick="this.form.target='_blank';this.form.action='../borrow/previewLoanPage.action';">
	</div>
