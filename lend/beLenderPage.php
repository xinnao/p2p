...
$sfz=htmlspecialchars($_POST['idNo']);
$tixian=htmlspecialchars($_POST['confirm_cashDrawPassword']);
$tixian=md5($tixian);
$phone=htmlspecialchars($_POST['mobile']);
$sql="update ".TABLEPRE."member set name='$name',sfz='$sfz',tixian='$tixian',phone='$phone' where uid='$uid'";
mysql_query($sql) or die(mysql_error());
echo '<meta http-equiv="refresh" content="0;URL=../guide.php">';
}
?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
<!--<meta http-equiv="refresh" content="0;URL=../guide.php">-->
...
<div id="page" class="session_invalid_tag">
    ...
    <!--header end-->
    <div id="regsteps">
    	<h3 style="margin-top: 30px; margin-bottom: 10px; color: rgb(253, 166, 78); font-size: 28px;">成为理财人</h3>
        ...
        <form id="toBeFinancierForm" action="beLenderPage.php" method="post">
        	<div id="toBeFinancierBox">
	            ...
	            <div class="reginput">
	                <label>身份证号：</label>
	               <input type="text" class="input180 intxt" name="idNo" id="idNo" value="进行实名认证，保障资金安全" onfocus="if(this.value=='进行实名认证，保障资金安全')this.value='';">
	            </div>
	            
	            
	            <div class="reginput" style="position:relative;height:55px;">
	                <label>提现密码：</label>
	                <input type="text"  style="position:absolute;top:0px;left:68px;" class="input180 intxt" value="提现时需验证，保障资金安全" onfocus="this.style.display='none';document.getElementById('cashDrawPassword').focus()" >
