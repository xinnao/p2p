...
if ("userInfo"==$_POST["fromType"]){
	$xueli=$_POST["graduation"];
	$ruxue=$_POST["graduatedYear"];
	$biye=$_POST["university"];
	$hunyin=$_POST["marriage"];
	$zinv=$_POST["hasChild"];
	$fang=$_POST["hasHouse"];
	$fangdai=$_POST["houseLoan"];
	$che=$_POST["hasCar"];
	$chedai=$_POST["carLoan"];
	$jiguansheng=$_POST["homeProvince"];
	$jiguanshi=$_POST["homeCity"];
	$hujisheng=$_POST["liveProvince"];
	$hujishi=$_POST["liveCity"];
	$zhuzhi=$_POST["address"];
$sql="update ".TABLEPRE."member set xueli='$xueli',ruxue='$ruxue',biye='$biye',hunyin='$hunyin',zinv='$zinv',fang='$fang',fangdai='$fangdai',che='$che',chedai='$chedai',jiguansheng='$jiguansheng',jiguanshi='$jiguanshi',hujisheng='$hujisheng',hujishi='$hujishi',zhuzhi='$zhuzhi' where uid='$uid'";
...
<form enctype="multipart/form-data" class="borrowForm" method="post" id="borrowForm" action="">
		...
		<div class="user_info_box_green clearfix" style="width: 548px;">
			...
			<div class="user_info_item">
				...
				<span> 
					...
					&nbsp;%（利率精确到小数点后一位<span id="rateFanwei">，范围<span id="minRate"></span>-<span id="maxRate"></span>之间
				</span>） 
	...
	<div style="text-align: center; margin: 10px 0; color: #4A74CA;">
		<input type="submit" id="saveBtn" class="mbtn save" value=""
			onclick="javascript:return saveAndPreview('save',,);">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		<input type="submit" id="publishBnt" class="mbtn publish" value=""
			onclick="javascript:return saveAndPreview('publish',,);">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
